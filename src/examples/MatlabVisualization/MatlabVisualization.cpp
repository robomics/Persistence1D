...
/*! \example MatlabVisualization.cpp
   ...
   [persistence_base_dir]\\src\\examples\\MatlabVisualization\\MatlabVisualizationRes.ref with
   contents:
...
int main() {
  ...
  // Since results are intended to be used within Matlab, set MatlabIndexing in all Get function
  // calls to get 1-based indexing results. Results retrieved without MatlabIndexing set to true are
  // 0-based.
  ...
  // Start Matlab
  // Change the directory to [persistence_base_dir]\matlab
  // Run: visualize_features('..\src\examples\MatlabVisualization\data.txt',
  // '..\src\examples\MatlabVisualization\res.txt')
